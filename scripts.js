document.addEventListener('DOMContentLoaded', () => {
    ...
    const tutorialContainer = document.getElementById('tutorial-page');
    ...
    // Event listener for showing tutorial page
    ...
    billSplitterForm.addEventListener('submit', (e) => {
        ...
        calculateButton.classList.add('custom-button');
    ...
    // Enable user-specific options
    function enableUserOptions() {
        document.querySelectorAll('.dropdown-content button[disabled]').forEach(button => {
    ...
    logoutButton.addEventListener('click', () => {
        ...
        document.querySelectorAll('.dropdown-content button').forEach(button => {
            if (button.id !== 'home-button' && button.id !== 'show-tutorial' && button.id !== 'show-login-page' && button.id !== 'toggle-theme') {
    ...
    // Function to handle restricted access for non-logged-in users
    function restrictAccess(button, targetSection) {
    ...
    restrictAccess(showAppPage, appContainer);
    restrictAccess(showDashboard, dashboardContainer);
    restrictAccess(showBillSplitter, billSplitterPage);
    restrictAccess(showFeedback, feedbackPage);
    restrictAccess(showChatbot, chatbotPage);
    restrictAccess(showProfileButton, profileContainer);
